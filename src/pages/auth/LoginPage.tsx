...
const demoAccounts = [
  ...
  { label: 'Margaret Rivera', sub: 'Principal of District · Riverside Unified', email: 'margaret.rivera@dist1.edu' },
  { label: 'Charles Lee', sub: 'Principal of District · Lakeside', email: 'charles.lee@dist2.edu' },
  ...
  { label: 'Testing – Principal of District 1', sub: 'Test account · Riverside Unified', email: 'test.dist1@demo.com' },
  { label: 'Testing – Principal of District 2', sub: 'Test account · Lakeside', email: 'test.dist2@demo.com' },
