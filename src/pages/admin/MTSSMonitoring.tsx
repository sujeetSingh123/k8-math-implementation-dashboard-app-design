    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Card>
          ...
          <p className="text-xs text-gray-400 mb-3">Data source: Administrator self-assessment using district capacity rubric. Edit indicators to reflect current conditions.</p>
          <div className="space-y-4">
