...
export const studentDataRecords: StudentDataRecord[] = [
  { id: 'sdr-1',  teacherId: 'T001', date: daysAgo(60), dataType: 'Benchmark Score',      value: 68, tier: 'Tier 1' },
  { id: 'sdr-2',  teacherId: 'T001', date: daysAgo(50), dataType: 'Progress Monitoring',  value: 71, tier: 'Tier 2' },
  { id: 'sdr-3',  teacherId: 'T001', date: daysAgo(42), dataType: 'Class Average',        value: 74, tier: 'Tier 1' },
  { id: 'sdr-4',  teacherId: 'T001', date: daysAgo(35), dataType: 'Progress Monitoring',  value: 76, tier: 'Tier 2' },
  { id: 'sdr-5',  teacherId: 'T001', date: daysAgo(28), dataType: 'Benchmark Score',      value: 79, tier: 'Tier 1' },
  { id: 'sdr-6',  teacherId: 'T001', date: daysAgo(21), dataType: 'Class Average',        value: 81, tier: 'Tier 1' },
  { id: 'sdr-7',  teacherId: 'T001', date: daysAgo(14), dataType: 'Progress Monitoring',  value: 83, tier: 'Tier 3' },
  { id: 'sdr-8',  teacherId: 'T001', date: daysAgo(7),  dataType: 'Class Average',        value: 85, tier: 'Tier 1' },
  { id: 'sdr-9',  teacherId: 'T002', date: daysAgo(55), dataType: 'Benchmark Score',      value: 62, tier: 'Tier 2' },
  { id: 'sdr-10', teacherId: 'T002', date: daysAgo(40), dataType: 'Progress Monitoring',  value: 65, tier: 'Tier 2' },
  { id: 'sdr-11', teacherId: 'T002', date: daysAgo(25), dataType: 'Class Average',        value: 67, tier: 'Tier 1' },
  { id: 'sdr-12', teacherId: 'T002', date: daysAgo(10), dataType: 'Progress Monitoring',  value: 70, tier: 'Tier 3' },
  { id: 'sdr-13', teacherId: 'T003', date: daysAgo(45), dataType: 'Benchmark Score',      value: 88, tier: 'Tier 1' },
  { id: 'sdr-14', teacherId: 'T003', date: daysAgo(30), dataType: 'Class Average',        value: 91, tier: 'Tier 1' },
  { id: 'sdr-15', teacherId: 'T003', date: daysAgo(15), dataType: 'Progress Monitoring',  value: 93, tier: 'Tier 2' },
  { id: 'sdr-16', teacherId: 'T004', date: daysAgo(50), dataType: 'Benchmark Score',      value: 55, tier: 'Tier 2' },
  { id: 'sdr-17', teacherId: 'T004', date: daysAgo(35), dataType: 'Progress Monitoring',  value: 52, tier: 'Tier 3' },
  { id: 'sdr-18', teacherId: 'T004', date: daysAgo(20), dataType: 'Class Average',        value: 58, tier: 'Tier 1' },
  { id: 'sdr-19', teacherId: 'T005', date: daysAgo(45), dataType: 'Class Average',        value: 75, tier: 'Tier 1' },
  { id: 'sdr-20', teacherId: 'T005', date: daysAgo(15), dataType: 'Progress Monitoring',  value: 79, tier: 'Tier 2' },
]
