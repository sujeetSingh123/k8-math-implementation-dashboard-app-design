...
const exportColumns = [
  ...
  { key: 'status', header: 'Status', render: (row: ExportRow) => <Badge color="green">{row.status}</Badge> },
  {
    key: 'download',
    header: '',
    render: () => (
      <button className="flex items-center gap-1 text-xs text-purple-600 font-medium hover:text-purple-800 cursor-pointer">
